...
export const listProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`http://amazing_cray:8000/api/products${keyword}`);
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`http://amazing_cray:8000/api/products/delete/${id}/`, config);
...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`http://amazing_cray:8000/api/products/create/`, {}, config);
...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://amazing_cray:8000/api/products/update/${product._id}/`,
      product,
      config
    );
  ...
  (productId, review) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `http://amazing_cray:8000/api/products/${productId}/reviews/`,
        review,
        config
      );
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://amazing_cray:8000/api/products/top/`);
